...
Whenever you are fixing a bug or adding a feature, you MUST document the changes in the project's `CHANGELOG.md` file. This ensures proper tracking of changes for the project and keeps users informed of updates.
- Group changes under headers like `Added`, `Fixed`, or `Changed`.
- Adhere to the Keep a Changelog standard and Semantic Versioning.
